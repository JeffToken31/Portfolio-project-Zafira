      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 justify-center items-center text-center sm:text-left">
          <div>
            ...
            <p>
              Depuis 2020, nous accompagnons les personnes en insertion
              professionnelle
            </p>
          ...
          <div>
            ...
            <div className="flex justify-center sm:justify-start items-center gap-2 mt-2">
              <Lucide.Mail size={18} />
              <a
                href="mailto:contact@zafira-solidaire.fr"
        ...
        <div className="mt-8 border-t border-gray-300 pt-6 text-sm text-gray-500">
          <p className="text-center mb-4">
            © {new Date().getFullYear()} Zafira Solidaire — Tous droits
            réservés.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 justify-center items-center text-center sm:text-left">
            <a
              ...
              className="flex items-center justify-center gap-1 hover:text-[var(--color-primary)] transition"
            >
